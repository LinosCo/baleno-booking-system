    ...
    <MainLayout userName="Arianna">
      <Tabs defaultValue="community-contents">
        <TabsList>
          ...
          <TabsTrigger value="toolbox">Toolbox by Hyper Island</TabsTrigger>
        ...
        <TabsContent value="community-contents" className="space-y-10">
          ...
          <div className="rounded-3xl border border-brand-100 bg-white/80 p-8 shadow-soft">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Browse field guides, templates and stories curated by the Sphere community.
            </p>
          </div>
        </TabsContent>
        <TabsContent value="toolbox">
          <div className="rounded-3xl border border-brand-100 bg-white/80 p-8 shadow-soft">
            <h3 className="text-lg font-semibold text-brand-700">Hyper Island Toolbox</h3>
            <p className="mt-2 text-sm text-slate-500">
